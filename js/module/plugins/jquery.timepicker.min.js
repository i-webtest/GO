      ...
      (e.TimePicker.prototype = {
        ...
        open: function (t) {
          ...
          switch (
            ...
            (t.rebuild = !1),
            n.container
              .removeClass('ui-helper-hidden ui-timepicker-hidden ui-timepicker-standard ui-timepicker-corners')
              .show(),
            t.options.theme)
          ) {
            case 'standard':
            ...
            r
              ? t.items.each(function () {
                  var i,
                    a = e(this);
                  return (
                    (i = e.fn.jquery < '1.4.2' ? e.fn.timepicker.parseTime(a.find('a').text()) : a.data('time-value')),
